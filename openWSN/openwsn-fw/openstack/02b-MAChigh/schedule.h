...
*/
#define SLOTFRAME_LENGTH    MAXACTIVESLOTS //should be 101
...
#define NUMSLOTSOFF          0
#define NUMSLOTSHARED 20
...
*/
#define MAXACTIVESLOTS       SCHEDULE_MINIMAL_6TISCH_ACTIVE_CELLS+NUMSLOTSOFF+NUMSLOTSHARED
